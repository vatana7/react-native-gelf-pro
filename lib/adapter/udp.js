...
var _ = require('lodash'),
  randomByte = require('react-native-randombytes'),
...
adapter._createSocket = function () {
  ...
  console.log(socket, "---------------------> SOCKET FROM PACKAGE:")
  // debug right fkin here
  return socket;
};
...
adapter.send = function (message, callback) {
  ...
  self.deflate(message, function (err, buf) {
    ...
    var packetId = Array.prototype.slice.call(randomByte.randomBytes(8)),
      chunksSent = 0;
